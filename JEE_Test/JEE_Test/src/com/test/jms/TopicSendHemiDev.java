...
public class TopicSendHemiDev {
  ...
  public static void main(String[] args) throws Exception {
    ...
    TopicSendHemiDev ts = new TopicSendHemiDev();
    ts.init(ic, TOPIC);
  ...
  protected static void readAndSend(TopicSendHemiDev ts) throws IOException, JMSException {
  ...
  protected static void readFromFileAndSend(TopicSendHemiDev ts) throws IOException, JMSException {
    BufferedReader msgStream = new BufferedReader(new InputStreamReader(System.in));
    String line = null;
    do {
      System.out.print("Enter message (\"quit\" to quit): \n");
  ...
  protected static InitialContext getInitialContext() throws NamingException {
    ...
    env.put(Context.PROVIDER_URL, "t3://snc-osb01-dvus.axusprvt.net:8001");
